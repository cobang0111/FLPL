...
from datasets import Features, Sequence, Value # for data debug
...
class RewardTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        #rewards_chosen = model(inputs["input_ids_chosen"], inputs["attention_mask_chosen"])[0]
        #rewards_rejected = model(inputs["input_ids_rejected"], inputs["attention_mask_rejected"])[0]
